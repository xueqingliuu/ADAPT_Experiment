...
THETA_ANTIC_NAMES = [
    ...
    "ws_morning*todayStepCount", "ws_afternoon*todayStepCount",
    "ws_morning*RPA", "ws_afternoon*RPA",
    "ws_morning*activityStatusToday", "ws_afternoon*activityStatusToday",
...
def _build_antic_design(dat: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray]:
    ...
    X = np.column_stack([
        ...
        ws_m, ws_a,
        ws_m * todayStepCount, ws_a * todayStepCount,
        ws_m * rpa, ws_a * rpa,
        ws_m * act, ws_a * act,
